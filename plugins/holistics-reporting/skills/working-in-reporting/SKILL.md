...
* **ALWAYS** read [](../../references/holistics.md), and other references if necessary, to understand the Holistics context properly. Your knowledge and assumptions about Holistics are likely inaccurate or outdated.
