...
* `holistics-reportin`: When you want to ask data questions on published AMQL objects (datasets, dashboards, etc.) with your general agents such as Claude.ai, ChatGPT, etc.

# Native Skills
Native skills (`native-skills/`) are skills that can be imported into Holistics App **for Holistics native AI agent** to use.
Their available toolings are Holistics native web UI and API features.
